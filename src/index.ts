    ...
    try {
      ...
      if (all) {
        const resp = await axios.get(
          `https://api.weatherapi.com/v1/forecast.json?q=${city}&days=1&tp=15&key=94a040c94bab4dcabf9130808222712`
        );
      ...
      const resp = await axios.get(
        `https://api.weatherapi.com/v1/current.json?q=${city}&lang=ua&key=94a040c94bab4dcabf9130808222712`
      );
